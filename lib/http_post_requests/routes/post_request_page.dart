...
class PostRequestPage extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            child: Text("Submit"),
            onPressed: () =>
                _submit(context, _titleController.text, _bodyController.text),
          ),
        ],
      ),
    );
  ...
  void _submit(BuildContext buildContext, String title, String body) {
    Navigator.pushNamed(buildContext, ResultPage.ROUTE_ID,
        arguments: Post.fromPropertiesToJson(42, title, body));
  }
}
